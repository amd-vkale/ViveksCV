\subsection*{Technical Leadership and Industry-grade Open-source GPU Software}

\myExpOne
{
\item Contributed kernel replay profiling feature (8K+ LOC) upstream to the open-source ROCm profiling ecosystem.
\item Developing and enhancing key areas of profiling for today’s workloads, e.g., always-on profiling, AI-assisted profiling tools, for ROCm ecosystem. 
\item Working with application team stakeholders, e.g., AI, HPC/Scientific Computing, to translate real application workload bottlenecks into tooling requirements.
\item Working with GPU architecture teams to align profiling capability with hardware counter and tracing support.
\item Leading cross-functional collaboration across research, testing/QA, data center GPU validation, to ensure success of product deployment for exascale supercomputing and rack-scale AI infrastructure. 
\item Engaging in open-source GPU software initiatives and standardization efforts,building on prior technical leadership on Kokkos, C++, HPSF, LLVM, LDMS and MPI+OpenMP standards.
}

\textbf{Advanced Micro Devices (AMD)}\\
{Principal Member of Technical Staff} \hfill \textit{June 2026 - Present}
%\vspace{-0.02in}
\noindent
...
{Principal Member of Technical Staff II} \hfill \textit{July 2024 - May 2026}
%\vspace{-0.02in}
\noindent
\begin{itemize}[itemsep=-0.1em]\onlyitems[include={1,2}]
\myExpTwo
